...
// FIX: Using React.PropsWithChildren to ensure 'children' is recognized by TypeScript, 
// as React.FC no longer includes it by default in React 18+.
...
// FIX: Correctly defining icon components to use IconWrapper with explicitly typed props.
